...
<head>
    ...
    <title>For Sale Search Result</title>
...
<body>
    <div class="container">
        <a href="for_sale.html" class="btn btn-info mt-3">Back to Property Search</a>';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $condo_fees = $_POST['property_taxes'] ?? null;
    ...
    switch ($operation) {
        case 'search':
            ...
            $query = "SELECT L.MLS_id, P.street_address, P.unit_no, P.city, P.state, P.zip_code, L.listing_price, P.year_built, P.architecture, P.bedrooms, P.bathrooms, P.home_type, P.sq_feet, P.lot_size, P.pool
            FROM Properties P, Listings L
            WHERE L.listing_status = 'for sale'
            ...
            $year_built, $architecture, $bedrooms, $bathrooms, $home_type, $sq_feet, $lot_size, $pool);
            ...
            while ($stmt->fetch()) {
                ...
                Address: $street_address $unit_no, $city, $state, $zip_code: Asking Price: $$listing_price<br>
                Year Built: $year_built, Style: $architecture, Bedrooms/Bathrooms: $bedrooms / $bathrooms, <br>
                Home Type: $home_type, Square Ft: $sq_feet, Lot Size: $lot_size, Pool: $pool</li>";
            }
